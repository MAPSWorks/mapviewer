...
#include "SphereCoveringPointAnswerPacket.h"
...
MT_IMPL(TSphereCoveringPointAnswerPacket)
...
MT_END(TSphereCoveringPointAnswerPacket)

GUID	TSphereCoveringPointAnswerPacket::Type = {0x62ef1113, 0xba84, 0x4bbb, 0x8d, 0x60, 0x6e, 0x36, 0x0b, 0x7a, 0xfa, 0x27};

TSphereCoveringPointAnswerPacket::TSphereCoveringPointAnswerPacket()
	:RequestID(0)
{
}

bool TSphereCoveringPointAnswerPacket::operator == (const TSphereCoveringPointAnswerPacket& s)
{
  return false;
}

bool TSphereCoveringPointAnswerPacket::Write(msg::TDataSetPtr s)
{
  s->Append();
...
bool TSphereCoveringPointAnswerPacket::Read(msg::TDataSetPtr s)
{
