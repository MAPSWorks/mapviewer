...
#include "SphereCoveringMapAnswerPacket.h"
...
MT_IMPL(TSphereCoveringMapAnswerPacket)
...
MT_END(TSphereCoveringMapAnswerPacket)

GUID	TSphereCoveringMapAnswerPacket::Type = {0x62ef1112, 0xba84, 0x4bbb, 0x8d, 0x60, 0x6e, 0x36, 0x0b, 0x7a, 0xfa, 0x27};

TSphereCoveringMapAnswerPacket::TSphereCoveringMapAnswerPacket()
	:RequestID(0)
{
}

bool TSphereCoveringMapAnswerPacket::operator == (const TSphereCoveringMapAnswerPacket& s)
{
  return false;
}

bool TSphereCoveringMapAnswerPacket::Write(msg::TDataSetPtr s)
{
  s->Append();
...
bool TSphereCoveringMapAnswerPacket::Read(msg::TDataSetPtr s)
{
