...
#include "SphereCoveringPointRequestPacket.h"
...
GUID	TSphereCoveringPointRequestPacket::Type = {0x73330b6a, 0x7972, 0x4aba, 0xa8, 0xa0, 0x5e, 0x2b, 0xef, 0x64, 0x77, 0xa9};

MT_IMPL(TSphereCoveringPointRequestPacket)
...
MT_END(TSphereCoveringPointRequestPacket)

TSphereCoveringPointRequestPacket::TSphereCoveringPointRequestPacket()
	:SrcX(0)
	,SrcY(0)
	,RequestID(0)
{
...
bool TSphereCoveringPointRequestPacket::operator == (const TSphereCoveringPointRequestPacket& s)
{
  return false;
}

bool TSphereCoveringPointRequestPacket::Write(msg::TDataSetPtr s)
{
  s->Append();
...
bool TSphereCoveringPointRequestPacket::Read(msg::TDataSetPtr s)
{
